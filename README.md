...
<body class="antialiased font-sans bg-gradient-to-b from-midnight-1 via-midnight-2 to-black text-slate-100">
      ...
      <a href="#" class="flex items-center gap-3">
        ...
        <div class="leading-tight">
          ...
          <div class="text-xs text-slate-400 -mt-0.5">Enterprise • Design • Velocity</div>
           <div class="mt-4 text-xs text-slate-400">Read more →</div>
        </article>
        ...
        <article class="reveal opacity-0 translate-y-8 transition-all duration-700 delay-100 p-6 rounded-2xl bg-gradient-to-b from-white/4 to-white/2 border border-white/6">
          <div class="font-semibold">Enterprise LogiChain</div>
          <p class="text-slate-300 text-sm mt-2">Optimasi prediksi demand & supply membuat biaya logistik turun 22%.</p>
          <div class="mt-4 text-xs text-slate-400">Read more →</div>
        </article>
        ...
        <article class="reveal opacity-0 translate-y-8 transition-all duration-700 delay-200 p-6 rounded-2xl bg-gradient-to-b from-white/4 to-white/2 border border-white/6">
          <div class="font-semibold">Securities Global</div>
          <p class="text-slate-300 text-sm mt-2">Integrasi AI anomaly detection berhasil mencegah fraud senilai 4.2M USD.</p>
          <div class="mt-4 text-xs text-slate-400">Read more →</div>
        </article>
      </div>
    </div>
  ...
  <section id="pricing" class="py-16 bg-black/30 border-t border-white/5">
    <div class="max-w-7xl mx-auto px-6">
      <div class="text-center">
        <h2 class="text-3xl font-bold">Harga & Paket</h2>
        <p class="text-slate-300 mt-2">Pilih paket sesuai kebutuhan bisnis Anda.</p>
      </div>

      <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        
        <!-- Basic -->
        <div class="p-8 rounded-2xl bg-gradient-to-b from-white/5 to-white/3 border border-white/10 shadow-xl">
          <h3 class="text-xl font-bold">Basic</h3>
          <p class="text-slate-400 text-sm mt-2">Cocok untuk pemula atau tim kecil.</p>
          <div class="mt-5 text-4xl font-bold">$19<span class="text-slate-400 text-lg">/month</span></div>

          <ul class="mt-6 space-y-3 text-sm">
            <li>✔ Live Market Data</li>
            <li>✔ Dashboard Real-time</li>
            <li>✔ Alert Dasar</li>
            <li class="text-red-400">✖ AI Prediction</li>
            <li class="text-red-400">✖ Unlimited Workspace</li>
          </ul>

          <button class="mt-6 w-full px-5 py-3 rounded-xl bg-white/10 hover:bg-white/20 transition font-semibold">Pilih Paket</button>
        </div>

        <!-- Pro -->
        <div class="p-8 rounded-2xl bg-gradient-to-b from-neon-cyan/20 to-neon-magenta/20 border border-neon-cyan/30 shadow-xl">
          <h3 class="text-xl font-bold">Pro</h3>
          <p class="text-slate-300 text-sm mt-2">Solusi terkuat untuk analisis tingkat lanjut.</p>
          <div class="mt-5 text-4xl font-bold">$49<span class="text-slate-300 text-lg">/month</span></div>

          <ul class="mt-6 space-y-3 text-sm">
            <li>✔ Semua fitur Basic</li>
            <li>✔ AI Anomaly Detection</li>
            <li>✔ Multi-Exchange Coverage</li>
            <li>✔ Akses API Developer</li>
            <li class="text-red-400">✖ Enterprise Support</li>
          </ul>

          <button class="mt-6 w-full px-5 py-3 rounded-xl bg-gradient-to-r from-neon-cyan to-neon-magenta text-white font-semibold shadow-md">Pilih Paket</button>
        </div>

        <!-- Enterprise -->
        <div class="p-8 rounded-2xl bg-gradient-to-b from-white/5 to-white/3 border border-white/10 shadow-xl">
          <h3 class="text-xl font-bold">Enterprise</h3>
          <p class="text-slate-400 text-sm mt-2">Untuk korporasi skala besar.</p>
          <div class="mt-5 text-4xl font-bold">Custom</div>

          <ul class="mt-6 space-y-3 text-sm">
            <li>✔ Semua fitur Pro</li>
            <li>✔ Dedicated Data Pipeline</li>
            <li>✔ AI Predictive Engine</li>
            <li>✔ Enterprise Support 24/7</li>
          </ul>

          <button class="mt-6 w-full px-5 py-3 rounded-xl bg-white/10 hover:bg-white/20 transition font-semibold">Hubungi Kami</button>
        </div>
      </div>
    </div>
  </section>

  <footer class="py-10 bg-black/40 border-t border-white/5">
    <div class="max-w-7xl mx-auto px-6 text-center">
      <div class="text-lg font-semibold tracking-wide">FUTURE EXPERIENCE</div>
      <p class="text-slate-400 mt-1 text-sm">Enterprise • Market Intelligence • High Velocity</p>
      <p class="text-slate-600 text-xs mt-4">© 2025 Future Experience. All rights reserved.</p>
    </div>
  </footer>
  ...
  <!-- APEXCHARTS MINI-CHARTS -->
  <script>
    function generateData() {
      let data = [];
      for (let i = 0; i < 20; i++) data.push(Math.floor(Math.random() * 100) + 20);
      return data;
    }

    const chartOptions = (color1, color2) => ({
    ...
    new ApexCharts(document.querySelector("#chart-btc"), chartOptions('#00F5FF')).render();
    new ApexCharts(document.querySelector("#chart-eth"), chartOptions('#FF3CA6')).render();
    new ApexCharts(document.querySelector("#chart-ihsg"), chartOptions('#10B981')).render();
  </script>
        </div>
      </a>
